...
export async function generateEmbgeddings(text: string) {
...
export async function generateAnswer(question: string, transcriptions: string[]) {
    ...
    const prompt = `
        Com base no texto fornecido (CONTEXTO) abaixo como contexto, responda a pergunta (PERGUNTA) de forma clara e precisa em português do Brasil.
